...
<script>
    ...
    export default {
        ...
        methods:{
          ...
          // 登出
            signout(){
                axios.get('http://ec2-54-199-244-110.ap-northeast-1.compute.amazonaws.com/php/signout.php').then(
                    (res) => {
                        console.log(res);
                        this.$message({
                            message: '已成功登出 ！ ',
            ...
            getUser() {
                ...
                axios.get('http://ec2-54-199-244-110.ap-northeast-1.compute.amazonaws.com/php/SESSION.php').then(
                    (res) => {
