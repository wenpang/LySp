    ...
    <div class="cardForm mt-5 mx-auto">
        ...
        <div class="card mt-5">
            <div class="card-body mt-4">
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" method="post" action="http://ec2-54-199-244-110.ap-northeast-1.compute.amazonaws.com/php/success.php">
...
import axios from 'axios';
    ...
    export default {
        ...
        methods: {
            ...
            previous() {
                axios.get('http://ec2-54-199-244-110.ap-northeast-1.compute.amazonaws.com/php/previous.php').then(
                    (res) => {
