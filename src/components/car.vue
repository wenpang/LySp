    ...
    export default {
        ...
        methods: {
            ...
            getPrevios() {
                ...
                let lists;
                axios.get("http://ec2-54-199-244-110.ap-northeast-1.compute.amazonaws.com/php/create.php").then(
                    (res) => {
            ...
            next() {
                ...
                if (this.checkCar.length > 0) {
                    ...
                    xhr.open('POST', 'http://ec2-54-199-244-110.ap-northeast-1.compute.amazonaws.com/php/checkList.php', true);
